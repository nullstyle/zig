...
pub const Csprng = posix_adapter.Csprng;
pub const Argv0 = posix_adapter.Argv0;

pub const Environ = posix_adapter.Environ;
...
pub const UseSendfile = posix_adapter.UseSendfile;
...
pub const UseFcopyfile = posix_adapter.UseFcopyfile;
...
pub const max_iovecs_len = posix_adapter.max_iovecs_len;
pub const splat_buffer_size = posix_adapter.splat_buffer_size;
...
pub const default_PATH = posix_adapter.default_PATH;
...
pub const PosixAddress = posix_adapter.PosixAddress;
pub const UnixAddress = posix_adapter.UnixAddress;
pub const posixAddressFamily = posix_adapter.posixAddressFamily;
pub const addressFromPosix = posix_adapter.addressFromPosix;
pub const addressToPosix = posix_adapter.addressToPosix;
pub const addressUnixToPosix = posix_adapter.addressUnixToPosix;
pub const errnoBug = posix_adapter.errnoBug;
pub const posixSocketModeProtocol = posix_adapter.posixSocketModeProtocol;
pub const recoverableOsBugDetected = posix_adapter.recoverableOsBugDetected;

pub const clockToPosix = posix_adapter.clockToPosix;
...
pub const statFromPosix = posix_adapter.statFromPosix;
...
pub const timestampFromPosix = posix_adapter.timestampFromPosix;
pub const nanosecondsFromPosix = posix_adapter.nanosecondsFromPosix;
const timestampToPosix = posix_adapter.timestampToPosix;
pub const setTimestampToPosix = posix_adapter.setTimestampToPosix;
pub const pathToPosix = posix_adapter.pathToPosix;
...
pub const copyCanon = posix_adapter.copyCanon;
...
pub const statusToTerm = posix_adapter.statusToTerm;
...
pub const fallbackSeed = posix_adapter.fallbackSeed;
...
pub const ChdirError = posix_adapter.ChdirError;
...
pub const closeFd = posix_adapter.closeFd;
